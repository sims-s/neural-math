...
if __name__ == "__main__":
    ...
    parser.add_argument('--min_prime_factor', type=int, default=20, help='Only save numbers that do not have primes smaller than this value as factors')
    parser.add_argument('--test_pct', type=float, default=.0025)
